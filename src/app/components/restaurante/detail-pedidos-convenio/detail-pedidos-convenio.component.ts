...
@Component({
  ...
  templateUrl: './detail-pedidos-convenio.component.html',
  styleUrls: ['./detail-pedidos-convenio.component.css']
})
export class DetailPedidosConvenioComponent implements OnInit {
